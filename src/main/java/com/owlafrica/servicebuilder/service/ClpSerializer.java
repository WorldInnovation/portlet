...
import com.owlafrica.servicebuilder.model.DepartmentClp;
import com.owlafrica.servicebuilder.model.EmployeeClp;
...
public class ClpSerializer {
        ...
        synchronized (ClpSerializer.class) {
            ...
            try {
                ...
                String portletPropsServletContextName = (String) getMethod.invoke(null,
                        "spring-portlet-deployment-context");
            ...
            if (Validator.isNull(_servletContextName)) {
                _servletContextName = "spring-portlet";
            }
    ...
    public static Object translateOutput(BaseModel<?> oldModel) {
        ...
        if (oldModelClassName.equals(
                    "com.owlafrica.servicebuilder.model.impl.DepartmentImpl")) {
        ...
        if (oldModelClassName.equals(
                    "com.owlafrica.servicebuilder.model.impl.EmployeeImpl")) {
    ...
    public static Throwable translateThrowable(Throwable throwable) {
        ...
        if (className.equals(
            ...
            return new com.owlafrica.servicebuilder.NoSuchDepartmentException();
        }

        if (className.equals(
                    "com.owlafrica.servicebuilder.NoSuchEmployeeException")) {
            return new com.owlafrica.servicebuilder.NoSuchEmployeeException();
        }
