...
/**
 * Provides the local service interface for Dep. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DepLocalServiceUtil
...
public interface DepLocalService extends BaseLocalService, InvokableLocalService,
    PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link DepLocalServiceUtil} to access the dep local service. Add custom service methods to {@link com.owlafrica.servicebuilder.service.impl.DepLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
