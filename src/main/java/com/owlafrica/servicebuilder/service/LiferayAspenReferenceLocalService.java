...
/**
 * Provides the local service interface for LiferayAspenReference. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see LiferayAspenReferenceLocalServiceUtil
...
public interface LiferayAspenReferenceLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link LiferayAspenReferenceLocalServiceUtil} to access the liferay aspen reference local service. Add custom service methods to {@link com.owlafrica.servicebuilder.service.impl.LiferayAspenReferenceLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
